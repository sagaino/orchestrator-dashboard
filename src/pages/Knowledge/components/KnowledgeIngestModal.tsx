...
import { useIngestKnowledge, useHarvestKnowledge, useProjects } from "@/hooks/use-orchestrator"
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  {projectsData && projectsData.length > 0 && (
                    <span className="text-[10px] text-slate-400">Pilih dari proyek terdaftar:</span>
                  )}
                </div>

                {/* Registered Projects Quick Click Pills */}
                {projectsData && projectsData.length > 0 && (
                ...
                <input
                  ...
                  placeholder="Contoh: /Users/sagaino/ciniru/identity-kit-dashboard-web"
                ...
                />
                <p className="text-[11px] text-slate-500">
                  Masukkan path folder absolut di sistem file lokal (bukan URL localhost / API).
                </p>
              </div>
